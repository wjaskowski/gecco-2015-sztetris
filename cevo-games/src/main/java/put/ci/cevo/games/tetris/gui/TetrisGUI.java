 ...
 * https://github.com/horizon-institute/Acopi_ResponseTris
 *
 */
public class TetrisGUI extends JFrame {
	...
	private void chooseAction() {
		TetrisAction action = agent.chooseAction(new TetrisState(board.getTetrisBoard(), currentType.getTetromino()),
