...
public interface CoevolutionaryDiversityMeasure<S, T> {
	...
	Measurement measureSolutionsDiversity(PayoffTable<S, T> payoffs, ThreadedContext context);

	Measurement measureTestsDiversity(PayoffTable<T, S> payoffs, ThreadedContext context);
}
