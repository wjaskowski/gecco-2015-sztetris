...
public class EvaluatedIndividual<T> implements Comparable<EvaluatedIndividual<T>>, Serializable {
	...
	public EvaluatedIndividual(T individual, double fitness, int effort) {
	...
	public EvaluatedIndividual(T individual, Fitness fitness, int generation, int effort) {
	...
	public static <T> Transform<EvaluatedIndividual<T>, Integer> toEffort() {
		return new Transform<EvaluatedIndividual<T>, Integer>() {
			@Override
			public Integer transform(EvaluatedIndividual<T> object) {
