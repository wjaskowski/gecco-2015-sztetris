...
public class TDLTetrisExperiment implements Runnable, Experiment {
	...
	private static final Logger logger = Logger.getLogger(TDLTetrisExperiment.class);
	...
	public void run() {
		...
		for (double eps : epses) {
			for (double alpha : alphas) {
				...
				DeltaNTuplesTetrisAgent deltaTetrisAgent = new DeltaNTuplesTetrisAgent(tetris, nTuples);
